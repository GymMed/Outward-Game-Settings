...
{
	public class SL_CharacterAIMeleeFixed : SL_CharacterAI
	{
        [XmlIgnore]
        [NonSerialized]
		public AISCombatMelee AISCombatMelee = null;
		...
		protected override void ApplyToCharacter(Character character)
		{
			...
			AISCombatMelee = new GameObject("4_Combat").AddComponent<AISCombatMelee>();
